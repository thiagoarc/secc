...
--
-- Host: localhost:8889
-- Generation Time: Oct 08, 2015 at 09:18 PM
...
(1, 2, 1, 'Caneta BIC', '10.00', 1, 21, '2015-09-21 00:00:00', '2015-09-21 00:00:00', 1),
...
--
ALTER TABLE `saida_produto`
  MODIFY `idsaida_produto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `solicitacao_produto`
  MODIFY `idsolicitacao_produto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `usuario_permissao`
  MODIFY `idusuario_permissao` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=116;
--
