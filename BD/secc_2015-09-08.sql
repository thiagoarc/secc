...
--
-- Host: localhost:8889
-- Generation Time: 08-Set-2015 às 17:49
...
--
ALTER TABLE `aditivo`
  ADD CONSTRAINT `fk_aditivo_compra1` FOREIGN KEY (`idcontrato`) REFERENCES `contrato` (`idcontrato`) ON DELETE NO ACTION ON UPDATE NO ACTION;
