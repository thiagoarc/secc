...
--
-- Host: localhost:8889
-- Generation Time: Nov 04, 2015 at 05:27 PM
...
--
ALTER TABLE `saida`
  MODIFY `idsaida` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `saida_produto`
--
ALTER TABLE `saida_produto`
  MODIFY `idsaida_produto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
