...
try{
	...
	$sql = "SELECT ec.idempenho_contrato, ec.idcontrato, ec.idfornecedor, f.razaosocial, ec.valor, ec.numero, f.cnpj FROM empenho_contrato ec, contrato c, fornecedor f WHERE  f.idfornecedor = ec.idfornecedor AND ec.idcontrato = c.idcontrato AND ec.idempenho_contrato = :id";
